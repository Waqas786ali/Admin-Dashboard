  ...
  return (
    <div className=' bg-half-transparent w-screen  fixed nav-item top-0 right-0'>
      <div className=' float-right h-screen dark:text-gray-200 bg-white dark:bg-secondary-dark-bg w-400'>
        <div className='mt-10 flex justify-between items-center p-4 ml-4'>
        ...
        <div className='flex-col border-color border-t-1 p-4 ml-4'>
          ...
          <div className='mt-4'>
            <input checked={currentMode === 'Light'} onClick={setMode} className=' cursor-pointer' type='radio' id='light' name='theme' value='Light' />
            <label htmlFor='light' className='ml-2 text-md cursor-pointer'>
              Light
            </label>
          </div>
          <div className='mt-4'>
            <input checked={currentMode === 'Dark'} onClick={setMode} className=' cursor-pointer' type='radio' id='dark' name='theme' value='Dark' />
